export class PersianCalendarService {
    ...
    PersianCalendarShort(gregorianDate): string {
      this.today = gregorianDate;
      this.gregorianYear = this.today.getFullYear();
      this.gregorianMonth = this.today.getMonth() + 1;
      this.gregorianDate = this.today.getDate();
      ...
      this.strday = this.day.toLocaleString();
      if (this.strday.length < 2) this.strday = "0" + this.strday;
  
      this.strMonth = Math.floor(this.month);
      this.strMonthShort = this.strMonth.toLocaleString();
      if (this.strMonthShort.length < 2) this.strMonthShort = "0" + this.strMonthShort;
  
      return this.year + this.strMonthShort + this.strday;
    ...
    toPersian(gregorianDate) {
      ...
      if (this.WeekDay == 6) this.strWeekDay = this.weekDayNames[0];
      else this.strWeekDay = this.weekDayNames[this.WeekDay + 1];
    }
